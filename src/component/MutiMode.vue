        ...
        initEcharts(mapData) {
            ...
            const option = {
                timeline: {
                    ...
                    data: ['变化图斑总面积', '农用地变化情况', '建设用地变化情况', '未利用地变化情况']
                },
                options: [
                    {
                        tooltip: {
                            ...
                            formatter: params => {
                                ...
                                if (data) {
                                    ...
                                    const bgColor = `background: linear-gradient(180deg, #E0F3FF 0%, #FFFFFF 100%);`
                                    tipsContent = `
                <div style="position:relative;padding:8px;${bgColor}">
                     ...
                     <div style="${fontStyle}height: 26px;line-height:26px;background: #C5E8FF;padding:0 8px;border-radius: 4px;">${data.value}亩</div>
                </div>
              `
                                }
                                return tipsContent
                        ...
                        visualMap: {
                            ...
                            pieces: [
                                { min: 5000, label: '>5000', color: '#399AEA' },
                                { min: 4000, max: 5000, label: '4000~5000', color: '#61B1EA' },
                                { min: 3000, max: 4000, label: '3000~4000', color: '#85C2E9' },
                                { min: 2000, max: 3000, label: '2000~3000', color: '#B5E0F6' },
                                { min: 0, max: 2000, label: '0~1000', color: '#DBEDF7' }
                            ],
                            textStyle: {
                                fontSize: 14,
                                textBorderWidth: 1
                        ...
                        tooltip: {
                            ...
                            formatter: params => {
                                ...
                                if (data) {
                                    const fontStyle = `color:#303133;font-weight:600;font-size:12px;text-align:center;`
                                    const arrowBg = require('@/assets/images/map/arrow.svg')
                                    const bgColor = `background: linear-gradient(180deg, #FFF9E8 0%, #FFFFFF 100%);`
                                    tipsContent = `
                <div style="position:relative;padding:8px;${bgColor}">
                     <div style="position:absolute;
                                 bottom:-9px;
                     ...
                     <div style="${fontStyle}">${data.name}</div>
                     <div style="${fontStyle}height: 26px;line-height:26px;background: #FFDC88;padding:0 8px;border-radius: 4px;">${data.value}亩</div>
                </div>
              `
                                }
                                return tipsContent
                        ...
                        visualMap: {
                            ...
                            backgroundColor: 'rgba(255,255,255,1)',
                            pieces: [
                                { min: 5000, label: '>5000', color: '#FEB939' },
                                { min: 4000, max: 5000, label: '4000~5000', color: '#FFCF69' },
                                { min: 3000, max: 4000, label: '3000~4000', color: '#FFDC88' },
                                { min: 2000, max: 3000, label: '2000~3000', color: '#FFEBAF' },
                                { min: 0, max: 2000, label: '0~1000', color: '#FFF6D7' }
                            ],
                            textStyle: {
                                fontSize: 14,
                                textBorderWidth: 1
              ...
              `
                        ...
                        visualMap: {
                            ...
                            backgroundColor: 'rgba(255,255,255,1)',
                            pieces: [
                                { min: 5000, label: '>5000', color: '#109EBB' },
                                { min: 4000, max: 5000, label: '4000~5000', color: '#4EB9CF' },
                                { min: 3000, max: 4000, label: '3000~4000', color: '#85D0E0' },
                                { min: 2000, max: 3000, label: '2000~3000', color: '#C2EAF3' },
                                { min: 0, max: 2000, label: '0~1000', color: '#E9FBFF' }
                            ],
                            textStyle: {
                                fontSize: 14,
                                textBorderWidth: 1
